...
namespace RegCom
{
    internal class Program
    {
        private static void ShowUsage()
        {
            ...
            Console.WriteLine();
            Console.WriteLine(
                "Syntax: RegCom [Options] /tlb:TypeLibraryFileName.tlb /dll:OutOfProc.dll /exe:ExeHostingOutOfProcDll.exe");
            Console.WriteLine();
            ...
            Console.WriteLine("\t{0,-25} {1}", "/key:user",
                "Per-user registration (in HKEY_CURRENT_USER) - default option");
        ...
        private static void ShowInvalidArgs()
        {
